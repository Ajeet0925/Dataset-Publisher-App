...
//1. Components are nothing but javascript functions that means create a file and made a function in it.
...
const Home = () => {
  return (
    <div>
      ...
      <div className="opendata" style={{marginTop:'5%'}}>
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              <div class="site">
                <h1 class="site__title" style={{fontWeight:'bold'}}>
                  Fast paced way to search DataSets
                </h1>
                <h2 class="site__subtitle">Manage Data like a boss</h2>
                <div class="site__box-link">
                  <a class="btn btn--width" href="/loginpage">
                    Login
                  </a>
                  <a class="btn btn--revert btn--width" href="signup">
                    Signup
                  </a>
                </div>
                <img
        ...
        <div class="container" style={{marginTop:'5%'}}>
          <div class="row row--center">
            ...
            <h2 class="row__sub">What fits your project the best?</h2>
          </div>
      ...
      <div class="sect sect--white">
        <div class="container">
          <div class="row">
            ...
            <h2 class="row__sub">
              Data you <span class="row__sub--light">(will)</span> propably
              know
            </h2>
          </div>
          <div class="row row--margin row--text-center" style={{marginLeft:'20%'}}>
            ...
            <div class="col-md-6 article-pre__col">
              <a href="#" class="article-pre ">
                ...
                <h2 class="article-pre__info">
                  ...
                  <span class="article-pre__aut"> by Ann Timothy</span>{" "}
                  <span class="article-pre__date"> - 5 mins read</span>
                </h2>
                <h1 class="article-pre__title">
                  How to improve analytics using few tools in OpenData
                  <span class="article-pre__arrow--purple"> →</span>
                </h1>
              </a>
            </div>
            ...
            <div class="col-md-6 article-pre__col">
              <a href="#" class="article-pre ">
                ...
                <h2 class="article-pre__info">
                  ...
                  <span class="article-pre__aut"> by Josh Ford</span>{" "}
                  <span class="article-pre__date"> - 5 mins read</span>
                </h2>
                <h1 class="article-pre__title">
                  Rich Thornett and Dan Coderholm about Dribbble in early 2009
                  <span class="article-pre__arrow--purple">→</span>
                </h1>
              </a>
            </div>
          ...
          <div class="row">
            <div class="col-md-6 article-pre__col">
              <a href="#" class="article-pre ">
                ...
                <h2 class="article-pre__info">
                  ...
                  <span class="article-pre__aut"> by Andrew Lincoln</span>{" "}
                  <span class="article-pre__date"> - 5 mins read</span>
                </h2>
                <h1 class="article-pre__title">
                  Steward Butterfield told us about his startup Slack
                  <span class="article-pre__arrow--purple"> →</span>
                </h1>
              </a>
            </div>
            ...
            <div class="col-md-6 article-pre__col">
              <a href="#" class="article-pre ">
                ...
                <h1 class="article-pre__title">
                  How to improve analytics using few tools in Bricks
                  <span class="article-pre__arrow--purple"> →</span>
                </h1>
              </a>
            </div>
          ...
          <div class="row">
            <div class="col-md-12">
              <h1 class="career_title">
                Oh! Your have digged our website in search for the new Dataset?
              </h1>
              <h1 class="career_sub">
                We will pleased to have you onboard! 
              </h1>
